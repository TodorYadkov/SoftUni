...
const host = 'http://127.0.0.1:5500/03.%20JS-Applications-Data-and-Authentication-Exercise-Resources/06.Furniture/index.html'; //"http://localhost:3000"; // Application host (NOT service host - that can be anything)
const interval = 300;
const DEBUG = false;
const slowMo = 500;
