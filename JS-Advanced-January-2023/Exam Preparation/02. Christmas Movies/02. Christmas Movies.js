...
// console.log(christmas.buyMovie('Last Christmas', ['Madison Ingoldsby', 'Emma Thompson', 'Boris Isakovic', 'Madison Ingoldsby'])); // You just got Last Christmas to your collection in which Madison Ingoldsby, Emma Thompson, Boris Isakovic are taking part!
// console.log(christmas.buyMovie('Home Alone', ['Macaulay Culkin', 'Joe Pesci', 'Daniel Stern'])); // You just got Home Alone to your collection in which Macaulay Culkin, Joe Pesci, Daniel Stern are taking part!
// console.log(christmas.buyMovie('Home Alone 2', ['Macaulay Culkin']));   // You just got Home Alone 2 to your collection in which Macaulay Culkin are taking part!
// console.log(christmas.buyMovie('The Grinch', ['Benedict Cumberbatch', 'Rashida Jones']));   // You just got The Grinch to your collection in which Benedict Cumberbatch, Rashida Jones are taking part!
// christmas.watchMovie('The Grinch');
// console.log(christmas.discardMovie('The Grinch'));    // You just threw away The Grinch!  
// christmas.watchMovie('Home Alone');
// christmas.watchMovie('Home Alone');
// christmas.watchMovie('Home Alone');
// christmas.watchMovie('Last Christmas');
// christmas.watchMovie('Last Christmas');
// console.log(christmas.favouriteMovie());    // Your favourite movie is Home Alone and you have watched it 3 times!
// console.log(christmas.mostStarredActor());  // The most starred actor is Macaulay 
